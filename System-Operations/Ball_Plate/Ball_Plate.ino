...
int stableX = 5,
    ...
    servoNeutralX  = 48,    //x axis, increase for CW rot.
    servoNeutralY  = 45,    //y axis. increase for CW rot.
...
PID PIDx(&currX, &outputX, &setPointX, Kp, Ki, 0, REVERSE);//MKI direct, MKII reverse
PID PIDy(&currY, &outputY, &setPointY, Kp, Ki, 0, REVERSE);//MKI direct, MKII reverse
