...
//Script used to test one set of Kp-Kd gain parameters on the ball
//and plate system over a two second period. Set Kp/Kd/time period on 
//lines 38,40,45 respectively. Output data is sent to serial.
